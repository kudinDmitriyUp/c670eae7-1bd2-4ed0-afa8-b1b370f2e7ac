...
export const metadata: Metadata = {
  title: "Luxe Haven - Premium Boutique Hotel | Luxury Stay",
  description: "Experience timeless elegance at Luxe Haven, an award-winning boutique hotel offering luxury suites, fine dining, and world-class service.",
  keywords: "luxury hotel, boutique hotel, premium accommodation, fine dining, spa wellness",
  openGraph: {
    title: "Luxe Haven - Premium Boutique Hotel",
    description: "Discover luxury and elegance at Luxe Haven. Award-winning service, exquisite dining, and refined accommodations.",
    type: "website",
    siteName: "Luxe Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764125528257-9o4zma03.jpg",
        alt: "Luxe Haven luxury hotel lobby"
      }
    ]
  },
  twitter: {
    ...
    title: "Luxe Haven - Premium Boutique Hotel",
    description: "Experience the pinnacle of boutique hospitality with luxury suites and world-class service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764125528257-9o4zma03.jpg"]
  },
  robots: {
    index: true,
    follow: true
